...
function mashThis(attrs, obj, belongsTo, transformFn, allProps, type) {
  ...
  if (attrs.key == "shadow") {
    ...
    var _cornerRadiiArray = [0, 0, 0, 0, 0, 0, 0, 0];
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        if (prop.key == "cornerRadius") {
          _cornerRadiiArray = _cornerRadiiArray.map(function () {
            return prop.value;
          });
          break;
          ...
          _cornerRadiiArray = [];
          for (var i = 0; i < cornerRadiis.length; ++i) {
            _cornerRadiiArray.push(cornerRadiis[i] * cornerRadius + "");
            _cornerRadiiArray.push(cornerRadiis[i] * cornerRadius + "");
          }
        }
      }
    ...
    prePend += "get_paint->setShadowLayer:dpf_" + shadowBlur + ",f_" + shadowOffset.x + ",f_" + shadowOffset.y + ",get_colorInt;";
...
var _require = __webpack_require__(/*! ../../utils */ "./src/utils.js"),
  ...
  alphaToHex = _require.alphaToHex;
