...
module.exports = {
  ...
  cancelAnim: function cancelAnim() {// TODO implement native side
  },
  updateAnim: function updateAnim() {// TODO implement native side
  }
};
...
function domAll(elem) {
  ...
  if (elem.parentType && "IOS" == "ANDROID") return prestoDom({
    elemType: type,
...
module.exports = function (type, config, _getSetType, namespace) {
  ...
  config.methods = [];
  config.alignment_rules = []; // tag set
