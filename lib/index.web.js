...
var getElementByView = function getElementByView(view, parentElement, siblingView, stopChild, renderStyle, onAnimationEnd) {
  if (!view.props.id) {
...
var inflateView = function inflateView() {
  ...
  var _getElementByView = getElementByView(view, parentElement, siblingView, stopChild, renderStyle, onAnimationEnd),
