  ...
  if (id) {
    ...
    if (elem) {
      ...
      if (cmd.listData) {
        ...
        view.props.diffArray = List.diffArray(view.props.itemDatas, x); //console.dir(view.props.diffArray)
...
function addPseudoClasses(elem, view) {
  ...
  if (props.hasOwnProperty("inputType")) {
    ...
    var style = ""; // 1000px hack added to fill input area
        ...
        if (eventType == "change") {
          ...
          if (eventType == "click") {
            ...
            var touchFeedbackFn = function touchFeedbackFn(e) {
              ...
              elem.style.backgroundColor = rippleColor; // elem.style.opacity = "0.5";
              // return the color of the element

              setTimeout(function () {
                elem.style.backgroundColor = ogBg; // prevent multiple clicks from permanently 
...
var createNewElement = function createNewElement(view, parentElement, siblingView) {
  ...
  switch (view.type) {
    case "webView":
      ...
      elem.style.border = 'none'; // This allow is the property of iframe for setting feature policy 
...
*/
window.presto_ui_version = "1.2.8";
