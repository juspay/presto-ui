...
function runInUI(cmd, namespace) {
  ...
  if (window.focusedElement) {
    var _elem = document.getElementById(window.focusedElement);
    if (_elem) {
      _elem.focus();
    }
...
function moveView(id, index) {
  ...
  if (window.focusedElement) {
    var elem = document.getElementById(window.focusedElement);
    if (elem) {
      elem.focus();
    }
    window.focusedElement = undefined;
...
function replaceView(view, id, namespace) {
  ...
  /* Append Children End */
  if (window.focusedElement) {
    var _elem2 = document.getElementById(window.focusedElement);
    if (_elem2) {
      _elem2.focus();
    }
    window.focusedElement = undefined;
...
window.presto_ui_version = "1.2.7";
