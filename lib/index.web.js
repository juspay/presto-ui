...
function addLayout(elem, type, props) {
  ...
  var scrollBarVisible = props.hasOwnProperty('scrollBarVisible') ? props.scrollBarVisible : true;
  var elem_style = "";
...
function initiateElement(type, props, elem) {
  ...
  var events = ['onClick', 'onEnterPressedEvent', 'onDeletePressedEvent', 'onRightArrowPressedEvent', 'onLeftArrowPressedEvent', 'onChange', 'onMouseDown', 'onMouseUp', 'onMouseEnter', 'onMouseOver', 'onMouseMove', 'onMouseOut', 'onMouseLeave', 'onFocus', 'onPaste', 'getInputEventData'];
...
*/
window.presto_ui_version = "1.0.36";
